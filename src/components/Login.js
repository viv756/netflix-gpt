...
const Login = () => {
  ...
  return (
    <div>
      ...
      <form className="p-12 bg-black absolute w-3/12 mt-36 mx-auto right-0 left-0 text-white rounded-lg bg-opacity-80">
        ...
        <p className="py-4 cursor-pointer text-md" onClick={toggleSignInForm}>
          {isSignInForm
